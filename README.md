...
- 474 test functions across 41 files in `trade/tests/`, plus 86 across 20 files in
...
```bash
.venv/bin/python -m pytest -q      # 474 tests, ~27 min (the stock page renders end-to-end)
```
