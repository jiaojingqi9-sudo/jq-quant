...
- 471 test functions across 40 files in `trade/tests/`, plus 86 across 20 files in
...
```bash
.venv/bin/python -m pytest -q      # 471 tests, ~27 min (the stock page renders end-to-end)
```
